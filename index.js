...
function openresume() {
  window.open(
    "https://drive.google.com/file/d/1OwEDxE0_EG8T4y8iWAbIC7R4CMJtWRoY/view?usp=sharing",
    "_blank"
  );
}
function topcode() {
...
function repaymaster() {
  window.open("https://github.com/neekunjchaturvedi/datanyx", "_blank");
}
function repaycode() {
  window.open("https://repaymaster.streamlit.app", "_blank");
}
